# Welcome Gaurav Kumar from Using Databases with Python
...
for entry in all:
    ...
    if name is None or artist is None or album is None:
        continue
    # print(name, artist, genre, album, genre, count, rating, length)
    ...
    genre_exists = cur.fetchone()
    if genre_exists: genre_id = genre_exists[0]
    else: genre_id = None
